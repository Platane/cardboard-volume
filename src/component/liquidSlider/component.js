...
(
    <svg
        ...
        <g ref="slideZone" transform={`translate( 20, 0 ) scale(${ ( width - 40 ) / width })`} onMouseDown={ onDown } onTouchStart={ onDown }>

            <g transform={`translate( ${ width * k }, 40 )`} onMouseDown={ onDown } onTouchStart={ onDown }>
                <circle cx={0} cy={0} r={5} { ...style.tic } />
            </g>
            ...
            <g transform={'translate( 0, 50 )'}>
                ...
                <path d={ toPath( wave_h, width, height) } { ...style.line } />
            </g>
        </g>
